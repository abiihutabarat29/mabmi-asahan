            ...
            <div class="col-md-5">
                <div class="wrap d-md-flex">
                    <div class="login-wrap p-4 p-md-5">
                        <div class="d-flex">
                            <div class="w-100">
                                <img src="dist/assets/img/logo-mabmi.png" class="mb-3" style="width:100px" />
                                <h6 class="mb-4">
                                    ADMINISTRATOR
                                </h6>
                            </div>
                        ...
                        <form action="{{ route('login') }}"class="mb-3" method="post">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-dark d-grid w-100 mb-2" type="submit">
                                    LOGIN
                                </button>
                                <hr>
                                <a href="{{ route('front.index') }}" class="btn btn-warning text-white d-grid w-100">
                                    WEBSITE
                                </a>
                            </div>
                        </form>
